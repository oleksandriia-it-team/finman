...
import { type BudgetPlan, type BudgetPlanDto, type PlannedDelayedExpense } from '@common/records/budget-plan.record';
...
describe('BudgetPlanLocalRepository', () => {
  ...
  it('should create a budget plan and 2 delayed expenses', async () => {
    ...
    const sentBudgetPlanDtoInDb: Omit<BudgetPlan, DefaultColumnKeys> = {
      month: Month.August,
      year: 2025,
      otherEntries,
      plannedOtherEntryIndexes: [0, 1],
