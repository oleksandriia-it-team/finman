...
import { getPlanVsActualApiUseCase } from '@backend/features/analytics/get-plan-vs-actual.api.use-case';
...
export const POST = createRoute({
  ...
  execute: async ({ context, body }) => {
    ...
    const data = await getPlanVsActualApiUseCase.execute({ ...body, userId });
