...
import { createEntrySchema, createUpdateEntrySchema } from '@common/domains/entry-base/entry-base.schema';

const RegularEntryTypes = [TypeEntry.Income, TypeEntry.Expense] as const;

const regularEntryExtraFields = {
...
export const RegularEntrySchema = createEntrySchema(regularEntryExtraFields);

export const UpdateRegularEntrySchema = createUpdateEntrySchema(regularEntryExtraFields);
